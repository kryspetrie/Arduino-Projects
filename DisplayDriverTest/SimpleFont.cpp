...
// Digit bitmap data
#ifdef _SF_DIGIT
uint32_t _digit[] = { 0x06b9d6 /*0*/, 0x026227 /*1*/, 0x0e178f /*2*/, 0x0f171f /*3*/,
...
// Alpha bitmap data
#ifdef _SF_ALPHA
uint32_t _alpha[] = { 0x069f99 /*A*/, 0x0e9f9e /*B*/, 0x069896 /*C*/, 0x0e999e /*D*/,
...
uint32_t _alphaBold[] = { 0x06dfdd /*A*/, 0x0edfde /*B*/, 0x06dcd6 /*C*/, 0x0eddde /*D*/,
...
#ifdef _SF_PUNC1
uint32_t _punc1[] = { 0x000000 /* */, 0x066602 /*!*/, 0x055500 /*"*/, 0x05f5f5 /*#*/,
		0x07af5e /*$*/, 0x0b264d /*%*/, 0x075ebd /*&*/, 0x062400 /*'*/, 0x024442 /*(*/,
		0x042224 /*)*/, 0x00a4a0 /***/, 0x004e40 /*+*/, 0x000624 /*,*/, 0x000f00 /*-*/,
		0x000066 /*.*/, 0x012648 /*/*/
};
#endif
...
#ifdef _SF_PUNC2
uint32_t _punc2[] = { 0x066066 /*:*/, 0x066024 /*;*/, 0x036c63 /*<*/, 0x00f0f0 /*=*/,
...
#ifdef _SF_PUNC3
uint32_t _punc3[] = { 0x064446 /*[*/, 0x084621 /*\*/, 0x062226 /*]*/, 0x069000 /*^*/,
		0x00000f /*_*/, 0x0c6200 /*`*/
};
#endif
...
#ifdef _SF_PUNC4
uint32_t _punc4[] = { 0x024242 /*{*/, 0x066666 /*|*/, 0x042424 /*}*/, 0x000db0 /*~*/};
#endif
...
#ifdef _SF_COMMON
	if (c == ':')		return 0x066066;
	else if (c == ' ')	return 0x000000;
	else if (c == '/')	return 0x012648;
	else if (c == '.')	return 0x000066;
	else if (c == ',')	return 0x000624;
	else if (c == '\'')	return 0x062400;
	else if (c == '?')	return 0x069206;
	else if (c == '!')	return 0x066602;
	else if (c == '-')	return 0x000f00;
#endif
